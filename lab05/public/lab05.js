...
function Remove(e){
    ...
    let firstName = e.parentNode.parentNode.childNodes[1].firstChild.innerHTML;
    let about = e.parentNode.parentNode.childNodes[1].childNodes[1].innerHTML;
    let portrait = e.parentNode.parentNode.firstChild.firstChild.src;
